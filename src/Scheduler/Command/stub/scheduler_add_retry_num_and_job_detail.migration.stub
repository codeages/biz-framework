...
class BizSchedulerAddRetryNumAndJobDetail extends Migration
{
    ...
    public function up()
    {
        ...
        $connection->exec("ALTER TABLE `biz_job_fired` ADD COLUMN `job_detail` text NOT NULL COMMENT 'job的详细信息，是biz_job表中冗余数据';");
    }
    ...
    public function down()
    {
        ...
        $connection->exec("ALTER TABLE `biz_job_fired` DROP COLUMN `job_detail`;");
    }
}
