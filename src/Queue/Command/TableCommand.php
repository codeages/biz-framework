...
class TableCommand extends AbstractCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        file_put_contents($filepath, file_get_contents(__DIR__.'/stubs/job.migration.stub'));

        $filepath = $this->generateMigrationPath($directory, 'biz_queue_failed_job');
        file_put_contents($filepath, file_get_contents(__DIR__.'/stubs/failed_job.migration.stub'));
