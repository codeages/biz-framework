    ...
    public function up()
    {
        ...
        $connection->exec("
            CREATE TABLE `target_log` (
              ...
              `target_type` varchar(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '日志对象类型',
              `target_id` int(11) NOT NULL DEFAULT '0' COMMENT '日志对象ID',
              `action` varchar(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '日志行为',
